import { ChatbotIntent, Message } from '../types/chatbot';

export const INITIAL_WELCOME_MESSAGE: Message = {
  id: 1,
  sender: 'bot',
  text:
    'Hello! Welcome to the **DroneTV AI Support & Lead Assistant**.\n\n' +
    'I can answer questions regarding our commercial drone services, professional pilot certification programs, registration steps, or connect you with our team.\n\n' +
    'Click a quick question below or type your inquiry!',
